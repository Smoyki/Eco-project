...
// Делаем кнопку активной
  ...
  <div class="glide__track" data-glide-el="track">
    <ul class="glide__slides">
      <li class="glide__slide"><img src="image1.jpg" alt="Изображение 1"></li>
      <li class="glide__slide"><img src="image2.jpg" alt="Изображение 2"></li>
      <li class="glide__slide"><img src="image3.jpg" alt="Изображение 3"></li>
    </ul>
  </div>
  <div class="glide__arrows" data-glide-el="controls">
    <button class="glide__arrow glide__arrow--prev" data-glide-dir="<">Назад</button>
    <button class="glide__arrow glide__arrow--next" data-glide-dir=">">Вперёд</button>
  </div>
